...
# --- Anchor (Unity scene-focal point ↔ Star Ferry crossing) ------------------
# The Hong_Kong.fbx is real-scale Victoria Harbour. We anchor at the TST↔Central
# narrows (the Star Ferry crossing) — that's the natural visual centre of a
# 1.3 km-wide scene, with Central piers on the south side of the ring and
# the TST waterfront on the north side.
# Note: the earlier value (22.3193, 114.1694) was labelled "HK_CENTER" but
# actually lands in Yau Ma Tei, ~1.5 km north of the TST waterfront — that
# put the camera ring on dry inland Kowloon instead of over the harbour.
